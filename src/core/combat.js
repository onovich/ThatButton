...
export function createCombatState(config = PROTOTYPE_BOSS_CONFIG) {
  ...
  return {
    ...
    tierLabel: enemy.tierLabel,
    avatarGlyph: enemy.avatarGlyph,
    sequenceLabel: enemy.sequenceLabel,
    identityKey: enemy.identityKey,
    attack: enemy.attack,
...
export function applyRoundClearDamage(combat = createCombatState(), {
  ...
  const damageResult = {
    ...
    tierLabel: previous.tierLabel,
    sequenceLabel: previous.sequenceLabel,
