...
- [Phase 7A Hazard Feel And Mobile Validation Goal Guide](phase-7a-hazard-feel-mobile-validation-goal-guide.md) - goal-mode execution guide for real-browser/mobile hazard smoke, readability evidence, and conservative hazard tuning before new mechanics or engine embedding.
